              ...
              <form method="POST" enctype="multipart/form-data" action="{{ route('users.store') }}">
                @csrf
                  ...
                  <div class="md-form mt-4">
                    ...
                    <p class="text-muted">現在<span class="string_num">0</span>文字入力中です。(160字以内)</p>
                  </div>  
                  <div class="form-group mt-4">
                    ...
                    <p class="text-muted">現在<span class="string_num">0</span>文字入力中です。(120字以内)</p>
                  </div>
                  <div class="from-group mt-4">
                    ...
                    <p class="text-muted">現在<span class="string_num">0</span>文字入力中です。(30字以内)</p>
                  </div> 
                   <div class="form-group mt-4">
                     <label class="font-weight-bold">大切な日の日付（試験日など）→今日から大切な日までのカウントダウンを実行できるよ！！</label>
                    <input type="text" class="form-control" name="important_day" id="important_day" placeholder="日付" value="{{ old('important_day') }}" />
                   </div>
