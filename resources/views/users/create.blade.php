              ...
              <form method="POST" enctype="multipart/form-data" action="{{ route('users.store') }}">
                @csrf
                  ...
                  <div class="md-form mt-4">
                    ...
                    <p class="text-muted">現在<span id="inputlength3">0</span>文字入力中です。(160字以内)</p>
                  </div>  
                  <div class="form-group mt-4">
                    ...
                    <p class="text-muted">現在<span id="inputlength4">0</span>文字入力中です。(120字以内)</p>
                  </div>
                  <div class="from-group mt-4">
                   ...
                   <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control text" name="important_day" id="important_day" placeholder="日付" value="{{ old('important_day') }}" />
                   </div>
