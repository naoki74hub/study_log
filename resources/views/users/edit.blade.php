              ...
              <form method="POST" enctype="multipart/form-data" action="{{ route('users.update', ['user' => $user]) }}">
                ...
                @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="goal" class="form-control textarea" onkeyup="ShowLength('inputlength2', value);" style="height:80px;">{{ $user->goal ?? old('goal') }}</textarea>
                  ...
                  <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control textarea" name="important_day" id="important_day" onkeyup="ShowLength('inputlength3', value);" value="{{ $user->important_day ?? old('important_day') }}" />
                  </div>
