              ...
              <form method="POST" enctype="multipart/form-data" action="{{ route('users.update', ['user' => $user]) }}">
                ...
                @method('PUT')
                  ...
                  <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control textarea" name="important_day" id="important_day" placeholder="日付" onkeyup="ShowLength('inputlength3', value);" value="{{ $user->important_day ?? old('important_day') }}" />
                  </div>
